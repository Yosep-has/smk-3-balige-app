...
<section class="section bg-light">
    <div class="container">
        ...
        <div class="card-grid">
            ...
            <div class="card">
                <h3>Misi</h3>
                <p>Menyelenggarakan pendidikan berbasis teknologi dan dunia industri.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="section">
    <div class="container">
        <h2 class="section-title center">
            STRUKTUR ORGANISASI SMK NEGERI 3 BALIGE <br>
            PERIODE 2025 / 2026
        </h2>
    ...
    <div class="container">
        ...
        <div class="card-grid">
            ...
            <div class="card">
                ...
                <p>Meraih juara dalam ajang Lomba Kompetensi Siswa bidang teknologi dan industri.</p>
            </div>
...
<section class="section">
    <div class="container">
        <h2 class="section-title center">Jurusan</h2>
        <div class="card-grid">
            <div class="card highlight">
                <h3>TKJ</h3>
                <p>Perhotelan</p>
